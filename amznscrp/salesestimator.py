...
class SalesEstimator:
    ...
    def __init__(self, path='./data', force_new_model_creation=False, force_teaching=False):
        ...
        self.__categories2 = CATEGORIES = [u'Auto & Motorrad',
                                           u'Baby',
                                           u'Baumarkt',
                                           u'Beauty',
                                           u'Bekleidung',
                                           u'Beleuchtung',
                                           u'Bücher',
                                           u'Bürobedarf & Schreibwaren',
                                           u'Computer & Zubehör',
                                           u'Drogerie & Körperpflege',
                                           u'DVD & Blu-ray',
                                           u'Elektro-Großgeräte',
                                           u'Elektronik & Foto',
                                           u'Fremdsprachige Bücher',
                                           u'Games',
                                           u'Garten',
                                           ...
                                           u'Haustier',
                                           u'Kamera',
                                           u'Koffer, Rucksäcke & Taschen',
                                           u'Küche, Haushalt & Wohnen',
                                           u'Lebensmittel & Getränke',
                                           u'Musikinstrumente',
                                           u'Schmuck',
                                           u'Schuhe & Handtaschen',
                                           u'Software',
                                           u'Spielzeug',
                                           u'Sport & Freizeit',
                                           u'Uhren']
